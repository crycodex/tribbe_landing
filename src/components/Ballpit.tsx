...
class X {
  #config: XConfig;
  #postprocessing: { render: () => void; setSize: (width: number, height: number) => void; dispose: () => void } | null = null;
  ...
  updateWorldSize() {
    if (this.camera.isPerspectiveCamera) {
      ...
      const cam = this.camera as { isOrthographicCamera?: boolean; top?: number; bottom?: number; right?: number; left?: number };
      if (cam.isOrthographicCamera && cam.top !== undefined && cam.bottom !== undefined && cam.right !== undefined && cam.left !== undefined) {
  ...
  set postprocessing(value: { render: () => void; setSize: (width: number, height: number) => void; dispose: () => void } | null) {
    ...
    this.scene.traverse(obj => {
      ...
      if (mesh.isMesh && typeof mesh.material === 'object' && mesh.material !== null) {
        Object.keys(mesh.material).forEach(key => {
          ...
          if (matProp && typeof matProp === 'object' && matProp !== null && 'dispose' in matProp && typeof matProp.dispose === 'function') {
            matProp.dispose();
          }
        });
...
class Y extends MeshPhysicalMaterial {
  ...
  constructor(params: Record<string, unknown>) {
    super(params);
    (this as Record<string, unknown>).defines = { USE_UV: '' };
...
const XConfig = {
  count: 200,
  colors: [0x3b82f6, 0x2563eb, 0x1d4ed8],
